...
| [[entities/perpdex/lighter]] | 5-state waterfall: TAV < IMR (Pre-Liq) → TAV < MMR (Partial) → TAV < CMR (Full) → ADL[^lighter-docs-2026-04-28-trading-liquidations-and-llp-insurance-fund] | yes — partial: IoC limit at zero price; full: LLP takes positions[^lighter-docs-2026-04-28-trading-liquidations-and-llp-insurance-fund] | LLP (strategy-isolated; insurance fund backstop)[^lighter-docs-2026-04-28-trading-liquidations-and-llp-insurance-fund-llp-strategies] | MMR ≈ 0.6·IMR, CMR ≈ 0.4·IMR[^lighter-docs-2026-04-28-trading-contract-specifications] | up to 1% to LLP; zero for prelaunch[^lighter-docs-2026-04-28-trading-liquidations-and-llp-insurance-fund] | zero-price formula: long = mark·(1 − M·TAV/MMR); short = mark·(1 + M·TAV/MMR); ADL if LLP undercapitalized[^lighter-docs-2026-04-28-trading-liquidations-and-llp-insurance-fund] |
