...
- A4-pov/PI: filled — LLP protocol-as-MM model; multi-strategy collateral shards (Crypto Perps / FX / Equities-RWAs)[^lighter-docs-2026-04-28-trading-liquidations-and-llp-insurance-fund-llp-strategies]
- A4-ext/PI: filled — LP program snapshot-based scoring; per-symbol/bps/size liquidity grid; 250k weekly points pool with 20% MM share[^lighter-docs-2026-04-28-liquidity-partner-program][^lighter-docs-2026-04-28-points-program-market-makers]
- A4-pov/PII: filled — XLP → LLP scope migration for RWAs (orderly takeover); Public Pools allow operator entry/exit without lockup (depositor-side onboarding)[^lighter-docs-2026-04-28-trading-real-world-assets-rwas][^lighter-docs-2026-04-28-trading-public-pools]
- A4-ext/PIII: gap — no markout-window or toxicity-class segregation in LP-program maker rebates; STP cancel-resting and weekly LP snapshot tiebreak address different concerns; quality-favoring scaling is qualitative only
- A4-pov/PIII: gap — LLP per-strategy NAV erosion / toxic-flow attribution not surfaced (LLP NAV is unified-then-allocated to strategies but no markout-by-strategy disclosure)
- A4-pov/PIV: filled — LLP-as-MM is excluded from points payout (redistributed); protocol-MM vs external-MM separation made explicit (the canonical Lighter pov-vs-ext separation rule)[^lighter-docs-2026-04-28-points-program-market-makers]
- A4-ext/PIV: filled — daily 8.33% liquidity-points floor; 50% daily cap on extreme-vol days (LP program normalization)[^lighter-docs-2026-04-28-points-program-market-makers]
- A4-ext/PV: filled — Premium-only eligibility for LP-program rewards is the codified external-MM counterparty model[^lighter-docs-2026-04-28-liquidity-partner-program]
- A4-pov/PV: filled — whitelist gating for Public Pool operators (LIT-staking-gated for LLP capacity, Premium gating not required for Public Pool deposit) is the codified pov-operator counterparty model[^lighter-docs-2026-04-28-trading-public-pools]
