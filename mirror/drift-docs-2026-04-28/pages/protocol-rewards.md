# Rewards – Drift Protocol
URL: https://docs.drift.trade/protocol/rewards
...
SyrupUSDC is Maple Finance's yield-bearing stablecoin. Trade using SyrupUSDC as collateral to enter into the $100,000 total rewards pool. For additional details on the campaign, please see the Maple blogpost
...
#### Have syrupUSDC deposited as collateral.

You must have syrupUSDC deposited in your account as collateral.

#### Maintain an active perpetual position.

You must maintain an active perpetual position to be eligible for rewards.
