...
URL: https://docs.drift.trade/protocol/getting-started/cross-collateral-deposits
...
(Loaded dynamically — see Drift UI / on-chain SpotMarket data for current values.)
...
### Main Pool LTVs / JLP Pool LTVs / Exponent Pool LTVs
