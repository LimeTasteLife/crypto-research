...
URL: https://docs.drift.trade/protocol/risk-and-safety/protocol-guard-rails
...
new data points for 5-minute oracle twap are sanitized to be within 10, 20, or 50% of the last twap value (depending on the `ContractTier`)
