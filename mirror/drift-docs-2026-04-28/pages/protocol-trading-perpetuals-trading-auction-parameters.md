...
URL: https://docs.drift.trade/protocol/trading/perpetuals-trading/auction-parameters
...
You can see the implementation of these auction settings here.

You can always review Auction Parameters for a particular order in the Confirmation Modal before submitting. (you can expand details with "Advanced" checked)
