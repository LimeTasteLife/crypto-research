...
URL: https://docs.drift.trade/protocol/trading/profit-loss/unsettled-profit-loss
...
This pool is called the P&L Pool (read more here: Accounting and Settlement).
...
If positive P&L is unsettled, it may account for less initial margin for trading perpetuals than USDC. Please see the treatment of non-USD assets here Cross-Collateral Deposits.
