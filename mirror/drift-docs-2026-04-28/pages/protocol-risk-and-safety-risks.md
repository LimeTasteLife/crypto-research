...
URL: https://docs.drift.trade/protocol/risk-and-safety/risks
...
The AMM has protections in place to prevent the long short imbalance from skewing too heavily to either side. More information on that is here at: Drift AMM. Despite these protections, there is still a risk that the AMM will be exposed to delta risk in periods of significant volatility.
