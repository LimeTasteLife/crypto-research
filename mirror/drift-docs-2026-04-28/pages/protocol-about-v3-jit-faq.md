# Just-in-Time (JIT) FAQ – Drift Protocol
URL: https://docs.drift.trade/protocol/about-v3/jit-faq
...
You can read docs here (Matching Engine) as well as read through an example trading bot ().

### Is the same JIT auction mechanism used for liquidations as well?

No, liquidations do not use auctions. Liquidators either take over user positions directly or fill liquidated users against resting liquidity.
...
Yes, you can access data on hourly, daily usage, and placeAndMake by market here: Dune Dashboard.
