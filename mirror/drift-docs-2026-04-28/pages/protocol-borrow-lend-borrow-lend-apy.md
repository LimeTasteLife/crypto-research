# Borrow & Lend APY – Drift Protocol
URL: https://docs.drift.trade/protocol/borrow-lend/borrow-lend-apy
...
Drift's interest rate is calibrated to manage liquidity risk and optimise asset utilisation. The formula for the borrow interest rates can be found at Borrow Interest Rate.
