# Basic Order Types – Drift Protocol
URL: https://docs.drift.trade/protocol/trading/order-types
...
These orders take against the AMM and are executed by a decentralised network of keepers, see Decentralised Orderbook FAQ, once certain conditions are met (i.e. the mark price crosses the specified trigger/limit price).
