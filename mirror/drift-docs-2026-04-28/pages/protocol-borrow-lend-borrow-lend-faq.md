...
URL: https://docs.drift.trade/protocol/borrow-lend/borrow-lend-faq
...
For `initial liability weight` for listed assets, see Cross-Collateral Deposits

What is the maintenance LTV?

`1 / maintenance liability weight`

For `maintenance liability weight` for listed assets, see Cross-Collateral Deposits
