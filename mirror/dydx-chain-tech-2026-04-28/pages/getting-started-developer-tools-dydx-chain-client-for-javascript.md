...
Source: https://docs.dydx.community/dydx-chain-technical-docs/getting-started/developer-tools/dydx-chain-client-for-javascript
...
Mobile apps need to load JS as a single JS file. To build, run:
