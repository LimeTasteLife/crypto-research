...
5. Sets the Uniswap Governance Timelock's address as the initial thresholdSetter
6. Transfers ownership of the Firepit to the Uniswap Governance Timelock's address
7. Deploys the V3FeeController contract, with the AssetSink as the destination for collected fees
8. Sets the Uniswap Governance Timelock's address as the initial feeSetter
9. Transfers ownership of the V3FeeController to the Uniswap Governance Timelock's address
