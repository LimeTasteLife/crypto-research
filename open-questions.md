...
### From aster-docs-2026-04-28 ingest (2 disputed)

- [[entities/perpdex/aster]] (#dispute-fee-rates) Is the canonical Aster perp fee rate the Perpetuals overview "0.01% maker / 0.035% taker" (`aster-docs-2026-04-28-trading-perpetuals#c4-c5`) or the Fees page "0% maker / 0.04% taker (USDT-perps), 0% / 0.005% (USD1-perps)" (`aster-docs-2026-04-28-trading-perpetuals-fees#c1-c4`)? Fees page TL;DR self-flags the contradiction; neither page is marked authoritative. Suggested verification: app.asterdex.com fee-display inspection on a live trade; on-chain transaction-fee analysis of recent USDT-perp and USD1-perp fills; direct team confirmation. Raised: 2026-04-28.
- [[entities/perpdex/aster]] / [[concepts/lp/vault]] (#dispute-alp-tax-basis-points) Is the ALP TaxBasisPoints value 0.05% (per the published USDT row `aster-docs-2026-04-28-earn-aster-alp-fees#c5`) or per-asset (the worked BTC example uses 0.45%, `aster-docs-2026-04-28-earn-aster-alp-fees#c14`)? Either per-asset config exists and the table omits the per-asset breakout, or one of the two values is stale. Suggested verification: ALP smart-contract per-asset parameter query; team confirmation; updated docs page review. Raised: 2026-04-28.
