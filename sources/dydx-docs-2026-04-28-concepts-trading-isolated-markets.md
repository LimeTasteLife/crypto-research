...
|----|-------|----------|-----------|
| #c1 | The Isolated Markets feature was added to the v4 chain software in v5.0.0. | [[entities/perpdex/dydx]], [[parameters/dydx-v4/upgrade-history]] | A1-PI |
...
| #c3 | Orders placed for other markets while a subaccount holds an open isolated position will fail and be cancelled at match time with error code 2005. | [[entities/perpdex/dydx]] | A6-PI |
...
| #c5 | The PerpetualParams proto contains a `market_type` field with two values: PERPETUAL_MARKET_TYPE_CROSS and PERPETUAL_MARKET_TYPE_ISOLATED. | [[entities/perpdex/dydx]] | A1-PI |
