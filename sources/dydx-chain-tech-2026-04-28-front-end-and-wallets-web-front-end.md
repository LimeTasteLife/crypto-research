...
|----|-------|----------|-----------|
| #c1 | The dYdX web front-end repository is v4-web at https://github.com/dydxprotocol/v4-web. | [[entities/perpdex/dydx-v4]] | A9-PV |
| #c2 | v4-web requires Node.js v18, pnpm, a Wallet Connect account, and (optionally) a Vercel or web3.storage account or IPFS Kubo client for deployment. | [[entities/perpdex/dydx-v4]] | A9-PV |
| #c3 | v4-web supports two deployment paths: Vercel (Vite framework preset) and IPFS (via web3.storage or IPFS Kubo). | [[entities/perpdex/dydx-v4]] | A9-PV |
