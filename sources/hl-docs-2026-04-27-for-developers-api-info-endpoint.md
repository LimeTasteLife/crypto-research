...
| #c8 | The Info endpoint exposes per-user staking delegations, staking summary, staking history, and staking rewards as separate query types. | [[entities/perpdex/hyperliquid]] | A7-PI |
| #c9 | The Info endpoint exposes per-user HIP-3 DEX abstraction state as a query type. | [[entities/perpdex/hyperliquid]] | A1-PI |
| #c10 | The Info endpoint exposes aligned-quote-token status as a queryable property. | [[entities/perpdex/hyperliquid]] | A2-PI |
...
| #c12 | Vault metadata (details, user deposits) is queryable per-vault via the Info endpoint. | [[entities/perpdex/hyperliquid]] | A5-PI |
